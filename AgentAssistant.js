...
let cleanupInterval;
let knowledgeEnhancementInterval;
let KNOWLEDGE_ENHANCEMENT_ENABLED;
let KNOWLEDGE_ENHANCEMENT_INTERVAL_MINUTES;
let KNOWLEDGE_ENHANCEMENT_TARGET_AGENT;
let KNOWLEDGE_ENHANCEMENT_PROMPT;
...
function shutdown() {
    ...
    if (knowledgeEnhancementInterval) {
        clearInterval(knowledgeEnhancementInterval);
        if (DEBUG_MODE) console.error('[AgentAssistant Service] Knowledge enhancement interval stopped.');
    }
